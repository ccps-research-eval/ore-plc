...
To do this, we can use the `lm()` function that's built into R. `lm()` stands for linear model, and it takes a few different arguments. The main ones we care about are:
